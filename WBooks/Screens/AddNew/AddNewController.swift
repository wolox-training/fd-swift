...
class AddNewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        bookTitle <~ _view.bookName.reactive.continuousTextValues.skipNil()
        bookAuthor <~ _view.bookAuthor.reactive.continuousTextValues.skipNil()
        bookYear <~ _view.bookYear.reactive.continuousTextValues.skipNil()
        bookGenre <~ _view.bookGenre.reactive.continuousTextValues.skipNil()
